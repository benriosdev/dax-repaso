...
(function () {
  ...
  function buildSidebarHTML() {
    var html = "";
    html += '<a class="side-home-link' + (currentPage === "home" ? " active" : "") + '" href="' + (basePath || './') + '"><i class="bi bi-house-door"></i> Inicio</a>';
  ...
  function renderRelatedTerms() {
    ...
    terms.forEach(function (t) {
      ...
      a.href = basePath + "glosario/#" + t.letterId;
    ...
    document.querySelectorAll(".topbar-search").forEach(function (wrap) {
      ...
      function render(q) {
        ...
        results.innerHTML = matches.map(function (m) {
          var e = m.e;
          var href = basePath + e.href + "#" + e.unitId;
  ...
  function initAnalytics() {
    if (location.hostname !== "benrios.dev") return;
    var id = "G-B7JYL0JMEV";
